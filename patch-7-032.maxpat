...
,
					"patching_rect" : [ 83.0, 503.5, 74.0, 22.0 ],
...
,
					"patching_rect" : [ 105.0, 483.5, 72.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 120.0, 465.0, 81.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 133.0, 445.0, 79.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 150.0, 425.0, 63.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 169.0, 405.0, 63.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 495.0, 105.0, 162.0, 22.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 183.0, 385.0, 70.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 195.0, 365.0, 83.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.5, 270.0, 173.0, 33.0 ],
					"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 47.5, 135.0, 32.5, 22.0 ],
									"style" : "",
									"text" : "180"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 155.0, 135.0, 75.0, 22.0 ],
									"style" : "",
									"text" : "random 360"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 80.0, 135.0, 75.0, 22.0 ],
									"style" : "",
									"text" : "random 360"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 180.0, 76.0, 22.0 ],
									"style" : "",
									"text" : "pack 0 0 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 210.0, 161.0, 35.0 ],
									"style" : "",
									"text" : ";\rlcd linesegment $1 $2 $3 $4"
								}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 315.0, 127.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 270.0, 55.0, 35.0 ],
					"style" : "",
					"text" : ";\rlcd clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 105.0, 68.0, 22.0 ],
					"style" : "",
					"text" : "receive lcd"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Patch 7-032. LeWitt's Wall Drawing 289 (1978)\nWilliam J Turkel\nhttp://williamjturkel.net/code/#programming"
				}
